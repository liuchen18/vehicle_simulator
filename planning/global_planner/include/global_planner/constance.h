...
static const int sampling_num=10;//the steering angle 
static const int max_steer_angle=30;//degree
static const double velocity=2.0;
static const double sample_time=0.1;
...
static const int max_iterations = 30000; //最大迭代次数
/// [m] --- Uniformly adds a padding around the vehicle
static const double bloating = 0; //膨胀范围
/// [m] --- The width of the vehicle
static const double width = 1.638 + 2 * bloating;//车的宽度
/// [m] --- The length of the vehicle
static const double length = 2.9 + 2 * bloating;//车的长度
/// [m] --- The minimum turning radius of the vehicle
static const float radius = 6;//最小转弯半径
